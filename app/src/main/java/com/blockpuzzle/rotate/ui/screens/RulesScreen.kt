...
fun RulesScreen(onBack: () -> Unit) {
    Column(
        ...
        RuleSection(title = "Как играть") {
            ...
            BulletText("Если в уровне включено вращение, перед установкой фигуру можно повернуть на 90° кнопкой со стрелкой под ней.")
            BulletText("Если включено отражение, рядом есть ещё одна кнопка — она отражает фигуру зеркально.")
        ...
        RuleSection(title = "Что значат настройки уровня") {
            ...
            BulletText("Отражение — если включено, у несимметричных фигур есть шанс появиться в зеркальном виде, и вы сами можете отразить фигуру кнопкой; если выключено, фигура всегда выпадает такой, какой её нарисовали, и отразить её нельзя.")
        }

        RuleSection(title = "Свои уровни") {
            Text(
                "Самое интересное в этой игре — сколько всего можно настроить под себя. " +
                    "В разделе «Конструктор» можно создать собственный уровень: выбрать " +
                    "размер поля, режим, алгоритм, вращение и отражение, а также нарисовать " +
                    "свои фигуры и задать, как часто каждая из них будет выпадать.",
                style = MaterialTheme.typography.bodyMedium
            )
        }
